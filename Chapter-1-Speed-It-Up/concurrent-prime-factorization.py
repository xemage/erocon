...
# We split our workload from one batch of 100,000 calculations
# into 10 batches of 10,000 calculations
def executeProc():
...
def main():
    ...
    # Use the .join() method in order to wait for
    ...
    t1 = time.time()
    totalTime = t1 - t0
    # Print out the total execution time for our 10
    # procs.
