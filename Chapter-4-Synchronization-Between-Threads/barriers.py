# Barriers are a synchronization primitive that were introduced in the third major iteration of
# the Python language, and address a problem that could only be solved with a somewhat
# complicated mixture of conditions and semaphores.
